          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-pink-100 to-purple-100 p-6 rounded-2xl border-2 border-pink-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div className="text-center">
                ...
                <h5 className="text-xl font-bold text-pink-600 mb-2">Blooming Beautiful</h5>
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-pink-100 p-6 rounded-2xl border-2 border-yellow-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div className="text-center">
                <div className="text-4xl mb-3">💎</div>
                <h5 className="text-xl font-bold text-yellow-600 mb-2">Precious Gem</h5>
                <p className="text-gray-700">You are rare, valuable, and absolutely irreplaceable in this world</p>
              </div>
            </div>
          </div>
        </div>
